...
<script type="text/javascript">
    $(document).ready(function () {
        var table = $('#questionTable').dataTable({
            ...
            ajax: {
                url: '/index.php/dataFunction/questionLists',
        ...
        $('#questionTable tbody').on('click', 'td.cursor', function () {
            var index = $(this).index('#questionTable tbody td.cursor');
            var stock_seq = $(".idx:eq(" + index + ")").val();
            location.href = '/index/question_view/' + stock_seq + '';
        });
