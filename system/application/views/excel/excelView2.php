<form style="display: block; height: 100%; width: 100%;" id="excellLoadForm" method="post" action="/index.php/dataFunction/excellDataSave2">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">배제어 일괄 등록</h4>
    </div>
