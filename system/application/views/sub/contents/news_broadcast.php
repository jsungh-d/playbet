...
<div class="right_col" role="main">
    <div class="page-title">
        <h3>뉴스관리(방송) <small>방송 대기 뉴스, 노출 뉴스를 관리합니다.</small></h3>
    </div>
    ...
    <div class="x_panel">
        <div class="x_content">
            ...
            <form class="form-horizontal form-label-left">
                ...
                <div class="form-group">
                    <div class="form-inline">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">방송사</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                    ...
                    <table class="table table-bordered dataTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th>뉴스내용</th>
                                <td>
                                    <textarea id="news_contents" class="form-control" rows="10" placeholder="뉴스 내용"></textarea>
                                </td>
                            </tr>
                            <tr>
                                <th>뉴스이동(종목)</th>
...
//            console.log(e.params.data);
        ...
        var table = $('#news_online_table1').dataTable({
            ...
            ajax: {
                url: '/index.php/dataFunction/newsObjectLists?news_kind=4&show=Y&sdate=' + sdate + '&edate=' + edate + '&time_chk=' + check + '&text=' + text + '',
...
//            ajax: '/index.php/dataFunction/newsObjectLists?news_kind=4&show=Y',
            columns: [
                {data: "checkbox"},
                {data: "news_title"}
            ],
        ...
        var table2 = $('#news_online_table2').dataTable({
            ...
            dom: '<"datatable_header"fl>t<"datatable_footer"Bp>',
            ajax: {
                url: '/index.php/dataFunction/newsObjectLists?news_kind=4&show=N&sdate=' + sdate + '&edate=' + edate + '&time_chk=' + check + '&text=' + text + '',
                dataSrc: function (json) {
                    json.draw = json.data.draw;
                    json.recordsTotal = json.data.recordsTotal;
                    json.recordsFiltered = json.data.recordsFiltered;
...
//            ajax: '/index.php/dataFunction/newsObjectLists?news_kind=4&show=N',
            columns: [
                {data: "checkbox"},
                {data: "news_title"}
            ],
...
//                    console.log(data);
        ...
        $('#searchBtn').click(function () {
            ...
            table.fnReloadAjax('/index.php/dataFunction/newsObjectLists?news_kind=4&show=Y&sdate=' + sdate + '&edate=' + edate + '&time_chk=' + check + '&text=' + text + '');
            table2.fnReloadAjax('/index.php/dataFunction/newsObjectLists?news_kind=4&show=N&sdate=' + sdate + '&edate=' + edate + '&time_chk=' + check + '&text=' + text + '');
        });
...
//                        return false;
    ...
    function statusSubmit2() {
        var data = {idx: $("#idxs2").val(), status: 0, news_kind: '4'};
        $.ajax({
            dataType: 'text',
    ...
    function statusSubmit1() {
        var data = {idx: $("#idxs1").val(), status: 1, news_kind: '4'};
        $.ajax({
            dataType: 'text',
            url: '/index.php/dataFunction/newsStatusChange',
            data: data,
