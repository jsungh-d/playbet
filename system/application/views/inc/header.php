...
<head>
    ...
    <link href="/vendors/bootstrap/bootstrap-progressbar-3.3.4.min.css" rel="stylesheet">
    <!-- JQVMap -->
    <link href="/vendors/jqvmap/jqvmap.min.css" rel="stylesheet"/>
    ...
    <!-- bootstrap-wysiwyg -->
    <link href="/vendors/prettify/prettify.min.css" rel="stylesheet">
    <!-- Select2 -->
    ...
    <!--crop-->
    <link href="/vendors/cropper/cropper.min.css" rel="stylesheet">
    <!-- Custom Theme Style -->
                                    ...
                                    <ul class="nav child_menu">
                                        ...
                                        <li>
                                            ...
                                            <ul class="nav child_menu">
                                                ...
                                                <li>
                                                    <a href="/index/keyword_kospi">메트릭스(종목)</a>
                                                </li>
                                                <?php } ?>

                                                <!--170827 매트릭스 일반 추가-->
                                                <li>
                                                    <a href="/index/keyword_general">메트릭스(일반)</a>
                                                </li>
                                                ...
                                                <!--170827 배재어 추가-->
                                                <li>
                                                    <a href="/index/keyword_exclude">배제어</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <?php } ?>
                                        ...
                                        <li>
                                            ...
                                            <ul class="nav child_menu">
                                                ...
                                                <li class="sub_menu">
                                                    <a href="/index/push">푸쉬관리</a>
                                                </li>
                                                <?php } ?>
                                                <li>
                                                    <a href="/index/push_calendar">푸쉬발송</a>
                                                </li>
                                            </ul>
                                        </li>
                                    </ul>
