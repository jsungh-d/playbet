<style type="text/css">
	...
	.option_list_span_0{display:none;}
...
<div class="right_col" role="main">
    <div class="page-title">
        <h3>메트릭스(종목) <small>종목별 분석된 키워드를 관리합니다.(키워드메트릭스)</small></h3>
    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var table1 = $('#keyword_kospiTable1').dataTable({
            ...
            ajax: {
                url: '/index.php/dataFunction/keywordStockLists',
...
//                    console.log(data);
        ...
        if ('<?= $this->input->get('text', true) ?>') {
            var text = '<?= $this->input->get('text', true) ?>';
