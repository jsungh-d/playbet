<!--기본이미지-->
<!--
http://222.234.2.150:1001/production/images/cropper.jpg
기본이미지 경로 편집해주세요
-->
<!-- page content -->
...
<!-- Cropper -->
<script type="text/javascript" src="/vendors/cropper/cropper.min.js"></script>
...
//            console.log(e.params.data);
                            ...
                            var table = $('#news_online_table1').dataTable({
                                ...
                                ajax: {
                                    url: '/index.php/dataFunction/newsObjectLists?news_kind=2&show=Y&sdate=' + sdate + '&edate=' + edate + '&time_chk=' + check + '&text=' + text + '',
...
//                                                        ajax: '/index.php/dataFunction/newsObjectLists?news_kind=2&show=Y',
                            ...
                            var table2 = $('#news_online_table2').dataTable({
                                ...
                                dom: '<"datatable_header"fl>t<"datatable_footer"Bp>',
                                ajax: {
                                    url: '/index.php/dataFunction/newsObjectLists?news_kind=2&show=N&sdate=' + sdate + '&edate=' + edate + '&time_chk=' + check + '&text=' + text + '',
                                    dataSrc: function (json) {
                                        json.draw = json.data.draw;
                                        json.recordsTotal = json.data.recordsTotal;
                                        json.recordsFiltered = json.data.recordsFiltered;
...
//                                                                $("#image").attr('src', data.news_img_path);
                                        ...
                                        $("#img_url").val(data.news_img_path);
                                        loadImg();
